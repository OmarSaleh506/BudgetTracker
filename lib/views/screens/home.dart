...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(
    ...
    if(_homeController.totalIncome.value < _homeController.totalExpense.value)
            return
    Container(
    margin: const EdgeInsets.all(1.0),
    padding: const EdgeInsets.only(left:100,top: 2,right: 100,bottom: 2),
    decoration: BoxDecoration(
    border: Border.all(color: expenseColor,),borderRadius: BorderRadius.all(Radius.circular(15))
    ),
    child: Text(
    ...
    else if (_homeController.totalIncome.value > _homeController.totalExpense.value)
      return
      Container(
        margin: const EdgeInsets.all(1.0),
        padding: const EdgeInsets.only(left:100,top: 2,right: 100,bottom: 2),
        decoration: BoxDecoration(
            border: Border.all(color: detailColor,),borderRadius: BorderRadius.all(Radius.circular(15))),
        child: Text(
